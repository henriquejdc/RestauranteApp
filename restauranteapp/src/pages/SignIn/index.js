    ...
    <View style={styles.container}>
      ...
      <Animatable.View animation='fadeInUp' style={styles.containerForm}>
        ...
        <Text style={styles.textTerms}>
          Ao logar, você concorda com os <A style={styles.textLinkTerms} href="https://mascdriver.github.io/restauranteapp/terms_and_conditions">termos e condições</A>  para o uso do aplicativo.
        </Text>
